  ...
  pillars: [
    {
      ...
      initiatives: [
        {
          id: "gradle-verification", title: "Gradle Verification", quarters: ["Q1"], dueDate: "Apr 30, 2026",
          ...
          tasks: [
            { id: "gv-learn", type: "learning", title: "Learning: Gradle Fundamentals", due: "Feb 14, 2026", subtasks: [
            ...
            { id: "gv-t1", type: "task", title: "Audit existing Gradle build scripts", due: "Feb 28, 2026", subtasks: [
            ...
            { id: "gv-t2", type: "task", title: "Configure `gradle check` task suite locally", due: "Mar 21, 2026", subtasks: [
            ...
            { id: "gv-t3", type: "task", title: "Integrate Gradle Wrapper and document setup", due: "Apr 11, 2026", subtasks: [
            ...
            { id: "gv-t4", type: "task", title: "Resolve critical failures and publish findings", due: "Apr 30, 2026", subtasks: [
        ...
        {
          id: "checkin-testing", title: "Check-in Testing", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          ...
          tasks: [
            { id: "ct-learn", type: "learning", title: "Learning: CI/CD Pipeline Concepts & Jenkins", due: "Mar 14, 2026", subtasks: [
            ...
            { id: "ct-t1", type: "task", title: "Define pipeline gates and merge eligibility rules", due: "Apr 11, 2026", subtasks: [
            ...
            { id: "ct-t2", type: "task", title: "Configure Jenkins webhook triggers on check-in", due: "May 30, 2026", subtasks: [
            ...
            { id: "ct-t3", type: "task", title: "Add Gradle check as a mandatory pre-merge CI stage", due: "Jun 27, 2026", subtasks: [
            ...
            { id: "ct-t4", type: "task", title: "Write pipeline step validation and create runbook", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "style-testing", title: "Style Testing", quarters: ["Q2","Q3"], dueDate: "Oct 31, 2026",
          ...
          tasks: [
            { id: "st-learn", type: "learning", title: "Learning: Linting, Code Style & Static Analysis", due: "May 30, 2026", subtasks: [
            ...
            { id: "st-t1", type: "task", title: "Select linter and define initial ruleset", due: "Jun 27, 2026", subtasks: [
            ...
            { id: "st-t2", type: "task", title: "Integrate linter as non-blocking CI stage", due: "Aug 29, 2026", subtasks: [
            ...
            { id: "st-t3", type: "task", title: "Publish style guide and establish expansion cadence", due: "Oct 31, 2026", subtasks: [
    ...
    },
    {
      ...
      initiatives: [
        {
          id: "code-patterns", title: "Code Patterns List", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          ...
          tasks: [
            { id: "cp-learn", type: "learning", title: "Learning: Design Patterns & Pipeline Architecture", due: "Feb 28, 2026", subtasks: [
            ...
            { id: "cp-t1", type: "task", title: "Catalog all pipeline jobs and shared libraries", due: "Mar 21, 2026", subtasks: [
            ...
            { id: "cp-t2", type: "task", title: "Identify recurring good patterns", due: "Apr 30, 2026", subtasks: [
            ...
            { id: "cp-t3", type: "task", title: "Identify anti-patterns and write remediation stories", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "fix-proposals", title: "Fix Proposals", quarters: ["Q2","Q3","Q4"], dueDate: "Dec 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "fp-learn", type: "learning", title: "Learning: Refactoring, Mockability & Dependency Injection", due: "Jun 13, 2026", subtasks: [
            ...
            { id: "fp-t1", type: "task", title: "Define the 'independent product' contract standard", due: "Jul 11, 2026", subtasks: [
            ...
            { id: "fp-t2", type: "task", title: "Refactor tightly-coupled pipeline stages", due: "Sep 26, 2026", subtasks: [
            ...
            { id: "fp-t3", type: "task", title: "Make functions mockable — replace hard dependencies with injectable interfaces", due: "Dec 31, 2026", subtasks: [
        ...
        {
          id: "library-ize", title: "Library-ize Common Code", quarters: ["Q3","Q4"], dueDate: "Dec 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "lib-learn", type: "learning", title: "Learning: Shared Libraries, Versioning & Package Management", due: "Aug 22, 2026", subtasks: [
            ...
            { id: "lib-t1", type: "task", title: "Select packaging strategy and scaffold the library", due: "Sep 19, 2026", subtasks: [
            ...
            { id: "lib-t2", type: "task", title: "Extract and bundle the top common functions", due: "Nov 14, 2026", subtasks: [
            ...
            { id: "lib-t3", type: "task", title: "Write unit tests and migrate existing jobs", due: "Dec 31, 2026", subtasks: [
  ...
  pillars: [
    {
      ...
      initiatives: [
        {
          id: "rerun-reuse", title: "Rerun / Reuse", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "rr-learn", type: "learning", title: "Learning: Jenkins Pipeline Restart & Stash/Unstash", due: "Feb 28, 2026", subtasks: [
            ...
            { id: "rr-t1", type: "task", title: "Spike: Evaluate partial rerun strategies", due: "Apr 30, 2026", subtasks: [
            ...
            { id: "rr-t2", type: "task", title: "Write fully-detailed stories for board", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "maintenance", title: "Maintenance: A/B Deployment", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          ...
          tasks: [
            { id: "maint-learn", type: "learning", title: "Learning: Jenkins HA, Blue/Green & Maintenance Windows", due: "Mar 14, 2026", subtasks: [
            ...
            { id: "maint-t1", type: "task", title: "Spike: A/B and maintenance deployment options", due: "May 30, 2026", subtasks: [
            ...
            { id: "maint-t2", type: "task", title: "Write fully-detailed stories for board", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "org-clarity", title: "Organizational: Job Clarity & Readability", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "org-learn", type: "learning", title: "Learning: Jenkins Job Naming, Folders & Description Best Practices", due: "Feb 28, 2026", subtasks: [
            ...
            { id: "org-t1", type: "task", title: "Audit current job naming and organization", due: "Apr 11, 2026", subtasks: [
            ...
            { id: "org-t2", type: "task", title: "Write stories for job clarity improvements", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "org-release-list", title: "Organizational: Release List Integration", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          description: "Release List used to update clients and other release-based jobs with the current release stage.",
          owner: "Pipeline Engineer",
          tasks: [
            { id: "rl-learn", type: "learning", title: "Learning: Release Management & Jenkins Parameters", due: "Mar 14, 2026", subtasks: [
            ...
            { id: "rl-t1", type: "task", title: "Design the Release List data model and integration points", due: "May 30, 2026", subtasks: [
            ...
            { id: "rl-t2", type: "task", title: "Write stories for Release List implementation", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "org-branding", title: "Organizational: Jenkins Branding Automation", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          ...
          tasks: [
            { id: "brand-learn", type: "learning", title: "Learning: Jenkins Themes & Configuration as Code", due: "Mar 7, 2026", subtasks: [
            ...
            { id: "brand-t1", type: "task", title: "Spike: Branding automation approach", due: "Apr 30, 2026", subtasks: [
            ...
            { id: "brand-t2", type: "task", title: "Write stories for branding automation", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "reporting-visuals", title: "Reporting: Visual Job Health & History", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "rv-learn", type: "learning", title: "Learning: Jenkins Reporting Plugins & Dashboards", due: "Mar 14, 2026", subtasks: [
            ...
            { id: "rv-t1", type: "task", title: "Audit current reporting gaps and evaluate plugins", due: "May 16, 2026", subtasks: [
            ...
            { id: "rv-t2", type: "task", title: "Write stories for visual reporting improvements", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "reporting-failures", title: "Reporting: Failed Stages & Log Improvements", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "rf-learn", type: "learning", title: "Learning: Jenkins Failure Cause & Log Parsing Plugins", due: "Mar 14, 2026", subtasks: [
            ...
            { id: "rf-t1", type: "task", title: "Catalog common failure modes and current log pain points", due: "Apr 25, 2026", subtasks: [
            ...
            { id: "rf-t2", type: "task", title: "Write stories for failure reporting improvements", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "reporting-folders", title: "Reporting: Folder History & Artifact Discovery", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          description: "Folders show history in a meaningful way — failure rate, average build time, and artifact discovery.",
          owner: "Pipeline Engineer",
          tasks: [
            { id: "rfd-learn", type: "learning", title: "Learning: Jenkins Folder-Level Metrics & Artifact Management", due: "Mar 14, 2026", subtasks: [
            ...
            { id: "rfd-t1", type: "task", title: "Define meaningful folder-level metrics", due: "Apr 25, 2026", subtasks: [
            ...
            { id: "rfd-t2", type: "task", title: "Write stories for folder reporting improvements", due: "Jul 31, 2026", subtasks: [
    ...
    },
    {
      ...
      initiatives: [
        {
          id: "story-review", title: "Story Review & Prioritization", quarters: ["Q2","Q3"], dueDate: "Oct 31, 2026",
          ...
          tasks: [
            { id: "sr-learn", type: "learning", title: "Learning: Story Writing, INVEST Criteria & Prioritization", due: "Jun 13, 2026", subtasks: [
            ...
            { id: "sr-t1", type: "task", title: "Consolidate and deduplicate all written stories", due: "Jul 31, 2026", subtasks: [
            ...
            { id: "sr-t2", type: "task", title: "Prioritize and finalize the board", due: "Oct 31, 2026", subtasks: [
    ...
    },
    {
      ...
      initiatives: [
        {
          id: "effectiveness-review", title: "Effectiveness Assessment", quarters: ["Q3","Q4"], dueDate: "Dec 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "ea-learn", type: "learning", title: "Learning: Measuring Developer Experience & Retrospective Techniques", due: "Sep 12, 2026", subtasks: [
            ...
            { id: "ea-t1", type: "task", title: "Collect data on completed improvements", due: "Oct 31, 2026", subtasks: [
            ...
            { id: "ea-t2", type: "task", title: "Retrospective and next-iteration planning", due: "Dec 31, 2026", subtasks: [
  ...
  pillars: [
    {
      ...
      initiatives: [
        {
          id: "bp-time-estimates", title: "Build Time Estimates & Baseline Report", quarters: ["Q1"], dueDate: "Apr 30, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "bp-te-learn", type: "learning", title: "Learning: DataDog APM, Traces & CI Visibility", due: "Feb 14, 2026", subtasks: [
            ...
            { id: "bp-te-t1", type: "task", title: "Instrument and collect build timing data", due: "Mar 21, 2026", subtasks: [
            ...
            { id: "bp-te-t2", type: "task", title: "Publish baseline build performance report", due: "Apr 30, 2026", subtasks: [
        ...
        {
          id: "bp-health-dashboard", title: "Build Health Dashboard", quarters: ["Q1","Q2"], dueDate: "Jul 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "bp-hd-learn", type: "learning", title: "Learning: Build Health Metrics & Dashboard Design", due: "Mar 14, 2026", subtasks: [
            ...
            { id: "bp-hd-t1", type: "task", title: "Define health metrics and data sources", due: "Apr 30, 2026", subtasks: [
            ...
            { id: "bp-hd-t2", type: "task", title: "Build and publish the health dashboard", due: "Jul 31, 2026", subtasks: [
    ...
    },
    {
      ...
      initiatives: [
        {
          id: "bp-common-failures", title: "Identify Common Build Failures", quarters: ["Q2"], dueDate: "Jul 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "bp-cf-learn", type: "learning", title: "Learning: Log Analysis & Root Cause Categorization", due: "May 16, 2026", subtasks: [
            ...
            { id: "bp-cf-t1", type: "task", title: "Catalog common failures by stage and cause", due: "Jun 27, 2026", subtasks: [
            ...
            { id: "bp-cf-t2", type: "task", title: "Register top failures in Build Failure Analyzer", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "bp-visual-reporting", title: "Visual Job State & History Reporting", quarters: ["Q2","Q3"], dueDate: "Oct 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "bp-vr-learn", type: "learning", title: "Learning: Jenkins Visual Plugins & DataDog Dashboard Advanced", due: "Jun 13, 2026", subtasks: [
            ...
            { id: "bp-vr-t1", type: "task", title: "Implement visual reporting for major build projects", due: "Aug 29, 2026", subtasks: [
            ...
            { id: "bp-vr-t2", type: "task", title: "Publish and communicate visual reporting to stakeholders", due: "Oct 31, 2026", subtasks: [
    ...
    },
    {
      ...
      initiatives: [
        {
          id: "bp-failure-discovery", title: "Refine Failure Discovery Process", quarters: ["Q3","Q4"], dueDate: "Dec 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "bp-fd-learn", type: "learning", title: "Learning: Continuous Improvement & Failure Triage Workflows", due: "Sep 12, 2026", subtasks: [
            ...
            { id: "bp-fd-t1", type: "task", title: "Establish recurring failure triage process", due: "Oct 31, 2026", subtasks: [
            ...
            { id: "bp-fd-t2", type: "task", title: "Document and institutionalize the failure discovery process", due: "Dec 31, 2026", subtasks: [
        ...
        {
          id: "bp-bottlenecks", title: "Bottleneck Remediation", quarters: ["Q4"], dueDate: "Dec 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "bp-bn-learn", type: "learning", title: "Learning: Pipeline Optimization Techniques", due: "Oct 17, 2026", subtasks: [
            ...
            { id: "bp-bn-t1", type: "task", title: "Identify and prioritize top 3 bottlenecks", due: "Nov 14, 2026", subtasks: [
            ...
            { id: "bp-bn-t2", type: "task", title: "Remediate top 3 bottlenecks and document results", due: "Dec 31, 2026", subtasks: [
  ...
  pillars: [
    {
      ...
      initiatives: [
        {
          id: "kn-ci-flow", title: "High-Level CI Flow Diagram & System Index", quarters: ["Q1"], dueDate: "Apr 30, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "kn-cf-learn", type: "learning", title: "Learning: Architecture Diagramming & CI System Concepts", due: "Feb 14, 2026", subtasks: [
            ...
            { id: "kn-cf-t1", type: "task", title: "Create the project index", due: "Mar 14, 2026", subtasks: [
            ...
            { id: "kn-cf-t2", type: "task", title: "Draw the high-level CI flow diagram", due: "Apr 30, 2026", subtasks: [
    ...
    },
    {
      ...
      initiatives: [
        {
          id: "kn-stack-docs", title: "Technical Stack Documentation", quarters: ["Q2"], dueDate: "Jul 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "kn-sd-learn", type: "learning", title: "Learning: Technical Writing & Getting Started Guide Best Practices", due: "May 16, 2026", subtasks: [
            ...
            { id: "kn-sd-t1", type: "task", title: "Document each primary system component", due: "Jul 31, 2026", subtasks: [
        ...
        {
          id: "kn-top20", title: "Top 20% Projects: Overview & Documentation Links", quarters: ["Q2"], dueDate: "Jul 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "kn-t20-t1", type: "task", title: "Identify and rank the top 20% of projects", due: "May 30, 2026", subtasks: [
            ...
            { id: "kn-t20-t2", type: "task", title: "Write overviews and link docs for top 20%", due: "Jul 31, 2026", subtasks: [
    ...
    },
    {
      ...
      initiatives: [
        {
          id: "kn-50pct", title: "50%+ Projects Listed with Overviews", quarters: ["Q3"], dueDate: "Oct 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "kn-50-t1", type: "task", title: "Document the next tier of projects (20%–50%)", due: "Sep 26, 2026", subtasks: [
            ...
            { id: "kn-50-t2", type: "task", title: "Review and quality-check 50%+ coverage", due: "Oct 31, 2026", subtasks: [
        ...
        {
          id: "kn-stack-requirements", title: "Technical Stack Requirements per Project", quarters: ["Q3"], dueDate: "Oct 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "kn-sr-learn", type: "learning", title: "Learning: Dependency Management & Environment Documentation", due: "Aug 22, 2026", subtasks: [
            ...
            { id: "kn-sr-t1", type: "task", title: "Document stack requirements for all indexed projects", due: "Oct 31, 2026", subtasks: [
    ...
    },
    {
      ...
      initiatives: [
        {
          id: "kn-remaining", title: "Remaining Projects — Full Index Coverage", quarters: ["Q4"], dueDate: "Dec 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "kn-rem-t1", type: "task", title: "Document remaining 50% of projects", due: "Nov 28, 2026", subtasks: [
            ...
            { id: "kn-rem-t2", type: "task", title: "Publish final project index and coverage report", due: "Dec 31, 2026", subtasks: [
        ...
        {
          id: "kn-gap-stories", title: "Missing Documentation Story Work", quarters: ["Q4"], dueDate: "Dec 31, 2026",
          ...
          owner: "Pipeline Engineer",
          tasks: [
            { id: "kn-gs-learn", type: "learning", title: "Learning: Writing Documentation Stories & Estimating Doc Debt", due: "Oct 17, 2026", subtasks: [
            ...
            { id: "kn-gs-t1", type: "task", title: "Write Jira stories for all documentation gaps", due: "Dec 31, 2026", subtasks: [
